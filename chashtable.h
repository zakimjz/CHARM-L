...
typedef HASHNS::hash_map<int, bool, 
                         HASHNS::hash<int>, equal_to<int> > IBhash; //Int2Bool
typedef HASHNS::hash_map<int, vector<int>, 
                         HASHNS::hash<int>, equal_to<int> > IVhash; //Int2Vec
#endif
